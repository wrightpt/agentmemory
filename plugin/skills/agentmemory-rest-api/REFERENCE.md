...
| POST | `/agentmemory/actions/gc` |
| GET | `/agentmemory/actions/get` |
| GET | `/agentmemory/actions/graph` |
...
| POST | `/agentmemory/enrich-session` |
...
| POST | `/agentmemory/input/cancel` |
| POST | `/agentmemory/input/claim` |
| POST | `/agentmemory/input/intents` |
| POST | `/agentmemory/input/settle` |
| POST | `/agentmemory/input/start` |
...
| POST | `/agentmemory/lessons/supersede` |
| GET | `/agentmemory/livez` |
| POST | `/agentmemory/llm/smoke` |
...
| POST | `/agentmemory/session/context` |
